...
(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'services.starlink.title': 'Starlink Installation & Management',
      'services.starlink.desc': 'End-to-end Starlink deployment — site survey, dish mounting and alignment, cable routing, and integration with existing networks (MikroTik, OPNsense, pfSense). Ongoing remote management, monitoring, and firmware oversight.',
      'services.starlink.i1': 'Site survey & obstruction check',
      'services.starlink.i2': 'Dish mounting & alignment',
      'services.starlink.i3': 'Cable routing & weatherproofing',
      'services.starlink.i4': 'Router integration (MikroTik / OPNsense)',
      'services.starlink.i5': 'Remote monitoring',
    ...
    el: {
      ...
      'services.starlink.title': 'Εγκατάσταση & Διαχείριση Starlink',
      'services.starlink.desc': 'Πλήρης εγκατάσταση Starlink — αυτοψία χώρου, τοποθέτηση και ευθυγράμμιση κεραίας, όδευση καλωδίωσης και ενσωμάτωση σε υπάρχοντα δίκτυα (MikroTik, OPNsense, pfSense). Συνεχής απομακρυσμένη διαχείριση, παρακολούθηση και επίβλεψη firmware.',
      'services.starlink.i1': 'Αυτοψία χώρου & έλεγχος εμποδίων',
      'services.starlink.i2': 'Τοποθέτηση & ευθυγράμμιση κεραίας',
      'services.starlink.i3': 'Όδευση & στεγανοποίηση καλωδίωσης',
      'services.starlink.i4': 'Ενσωμάτωση router (MikroTik / OPNsense)',
      'services.starlink.i5': 'Απομακρυσμένη παρακολούθηση',
      'services.cert.mtcna.title': 'MikroTik Certified Network Associate',
      'services.cert.mtcna.org': 'MikroTik Training Center',
