...
(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'pentest.deepdive': 'See how I work: HackTheBox machine walkthroughs & security writeups →',
      'pentest.cta.title': 'Request a scoping call',
      'pentest.cta.desc': "Tell me what you'd like tested and roughly how big it is. I'll suggest the right engagement and send a tailored quote — no obligation.",
      'pentest.form.name': 'Name',
      'pentest.form.email': 'Email',
      'pentest.form.company': 'Company (optional)',
      'pentest.form.message': 'What would you like tested? (e.g. a web app + its API, ~30 endpoints)',
      'pentest.form.submit': 'Request scoping call',
      'pentest.form.or': 'or reach me directly',
      'pentest.form.sending': 'Sending…',
      'pentest.form.success': "Got it ✓ — I'll reply to your email within 24 hours.",
      'pentest.form.error': 'Something went wrong — please email me directly.',
    ...
    el: {
      ...
      'pentest.deepdive': 'Δες πώς δουλεύω: αναλύσεις μηχανημάτων HackTheBox & writeups ασφαλείας →',
      'pentest.cta.title': 'Ζητήστε κλήση εμβέλειας',
      'pentest.cta.desc': 'Πείτε μου τι θέλετε να ελεγχθεί και πόσο μεγάλο είναι περίπου. Θα προτείνω τη σωστή ανάθεση και θα στείλω εξατομικευμένη προσφορά — χωρίς δέσμευση.',
      'pentest.form.name': 'Όνομα',
      'pentest.form.email': 'Email',
      'pentest.form.company': 'Εταιρεία (προαιρετικό)',
      'pentest.form.message': 'Τι θέλετε να ελεγχθεί; (π.χ. μια εφαρμογή web + το API της, ~30 endpoints)',
      'pentest.form.submit': 'Ζήτησε κλήση εμβέλειας',
      'pentest.form.or': 'ή επικοινώνησε απευθείας',
      'pentest.form.sending': 'Αποστολή…',
      'pentest.form.success': 'Έλαβα το αίτημά σου ✓ — θα απαντήσω εντός 24 ωρών στο email σου.',
      'pentest.form.error': 'Κάτι πήγε στραβά — στείλε μου email απευθείας.',
