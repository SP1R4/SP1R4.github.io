...
const FALLBACK_REPOS = [
  ...
  { name: 'PhantomTrap', description: 'High-interaction honeypot framework with behavioral fingerprinting, campaign detection, and real-time dashboard', language: 'Python', stargazers_count: 0, forks_count: 0, html_url: 'https://github.com/SP1R4/PhantomTrap', topics: ['blue-team', 'cybersecurity', 'dashboard', 'honeypot', 'network-security', 'python', 'security', 'threat-intelligence'] },
  { name: 'Qsafe', description: 'Post-quantum file encryption tool using Kyber1024 + AES-256-GCM', language: 'C', stargazers_count: 0, forks_count: 0, html_url: 'https://github.com/SP1R4/Qsafe', topics: ['aes-256', 'c', 'cryptography', 'encryption', 'kyber', 'post-quantum', 'quantum-resistant', 'security'] },
  { name: 'hashcracker', description: 'Professional hash identification and cracking toolkit for security experts. Identifies 60+ hash types with confidence scoring, cracks via hashcat & John the Ripper.', language: 'Python', stargazers_count: 0, forks_count: 0, html_url: 'https://github.com/SP1R4/hashcracker', topics: ['cli', 'cybersecurity', 'hash-cracking', 'hashcat', 'john-the-ripper', 'penetration-testing', 'python', 'security-tools'] },
  { name: 'FundsForwarder', description: 'Non-custodial ETH/ERC-20 forwarding smart contract — Solidity, Hardhat, OpenZeppelin, 100% test coverage, timelocked ownership', language: 'JavaScript', stargazers_count: 0, forks_count: 0, html_url: 'https://github.com/SP1R4/FundsForwarder', topics: ['automation', 'blockchain', 'crypto', 'erc20', 'ethereum', 'funds', 'javascript', 'transaction', 'wallet', 'web3'] },
  { name: 'plexus-network-planner', description: 'Plexus — cross-platform network site planner: WiFi + IP cameras + switches/PoE. Predictive wall-aware ray-cast coverage, SNR/throughput heatmaps, topology & cabling, branded PDF/BoM exports. Desktop apps for macOS/Windows/Linux, or runs offline in the browser.', language: 'JavaScript', stargazers_count: 2, forks_count: 0, html_url: 'https://github.com/SP1R4/plexus-network-planner', topics: ['access-points', 'coverage', 'desktop-app', 'electron', 'floor-plan', 'heatmap', 'ip-camera', 'mikrotik', 'network-planning', 'poe', 'ray-casting', 'rf-planning', 'site-survey', 'spa', 'unifi', 'vanilla-js', 'vite', 'wifi', 'wifi-planner', 'wireless'] },
  { name: 'sentrynotch', description: "A permission checkpoint for coding agents, living in your Mac's notch.", language: 'Swift', stargazers_count: 1, forks_count: 0, html_url: 'https://github.com/SP1R4/sentrynotch', topics: ['agentic-ai', 'ai-agents', 'claude', 'claude-code', 'developer-tools', 'llm', 'macos', 'menubar', 'notch', 'permissions', 'swift', 'swiftui'] },
  { name: 'ctf-toolkit-setup', description: 'Architecture-aware CTF toolkit installer for Ubuntu (apt/pip/gem/GitHub)', language: 'Shell', stargazers_count: 0, forks_count: 0, html_url: 'https://github.com/SP1R4/ctf-toolkit-setup', topics: [] },
  { name: 'CMDR', description: 'A command manager for CTF players and pentesters: store, parameterize, and run shell commands with workspaces, hosts, output→env chaining, playbooks, findings/reporting, and encrypted workspaces.', language: 'Shell', stargazers_count: 0, forks_count: 0, html_url: 'https://github.com/SP1R4/CMDR', topics: ['bash', 'cli', 'command-line', 'command-manager', 'ctf', 'jq', 'offensive-security', 'pentesting', 'productivity', 'redteam', 'shell', 'snippets', 'terminal'] },
];
